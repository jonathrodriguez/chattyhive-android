 ...
 */
public class SubscriberList<E extends ISubscribable> implements Collection<Subscription<E>> {
    ...
    public boolean add(Subscription<E> subscription) {
        ...
        if ((subscription.getUser().getUserID() == null) || (subscription.getUser().getUserID().isEmpty()))
            throw new IllegalArgumentException();

        boolean result = this.subscriptions.containsKey(subscription.getUser().getUserID());

        if (!result)
            this.subscriptions.put(subscription.getUser().getUserID(), subscription);
    ...
    public boolean remove(Object o) {
        ...
        if (result)
            this.subscriptions.remove(subscription.getUser().getUserID());
