...
/**
 * ParamsRespondRequest
 * <p>
 * URL params for the Respond Request method.
 *
 */
@Generated("org.jsonschema2pojo")
public class URL_RESPOND_REQUEST {
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof URL_RESPOND_REQUEST) == false) {
            return false;
        }
        URL_RESPOND_REQUEST rhs = ((URL_RESPOND_REQUEST) other);
